...
public class AetherLinkMongoDBGrainStorageConfigurator : IPostConfigureOptions<MongoDBGrainStorageOptions>
{
    private readonly IServiceProvider _serviceProvider;

    public AetherLinkMongoDBGrainStorageConfigurator(IServiceProvider serviceProvider)
    {
