...
public class AetherLinkJsonGrainStateSerializer : IGrainStateSerializer
{
    private readonly JsonSerializerSettings jsonSettings;

    public AetherLinkJsonGrainStateSerializer(IOptions<JsonGrainStateSerializerOptions> options,
