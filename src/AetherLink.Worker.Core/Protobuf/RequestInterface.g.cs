...
namespace AetherLink.Contracts.Consumer {
  ...
  internal static partial class RequestInterfaceReflection {
  ...
  #region Messages
  internal sealed partial class StartOracleRequestInput : pb::IMessage<StartOracleRequestInput>
  ...
  internal sealed partial class HandleOracleFulfillmentInput : pb::IMessage<HandleOracleFulfillmentInput>
  #if !GOOGLE_PROTOBUF_REFSTRUCT_COMPATIBILITY_MODE
      , pb::IBufferMessage
  #endif
  {
  ...
  internal sealed partial class OracleResponse : pb::IMessage<OracleResponse>
  #if !GOOGLE_PROTOBUF_REFSTRUCT_COMPATIBILITY_MODE
      , pb::IBufferMessage
  #endif
  {
