...
{
    public class EntityFrameworkCoreAetherLinkServerDbSchemaMigrator
        : IAetherLinkServerDbSchemaMigrator, ITransientDependency
    {
        private readonly IServiceProvider _serviceProvider;

        public EntityFrameworkCoreAetherLinkServerDbSchemaMigrator(IServiceProvider serviceProvider)
        {
